<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fLoginUser.aspx.cs" Inherits="ITWork.Administrator.Account.fLoginUser" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <!-- Original URL: http://themedesigner.in/demo/admin-press/main/pages-login.html
Date Downloaded: 11/30/2018 3:41:43 PM !-->
                ...
                <div class="card-body">
                    <div class="form-horizontal form-material">
                        ...
                        <asp:Panel ID="pnThongbao" runat="server">
                            <div class="alert alert-danger alert-rounded" style="font-size:13px">
                                <i class="ti-announcement" style="margin-right:7px"></i>Incorrect account information or password
                                </div>
                        </asp:Panel>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 font-14">
                                ...
                                </div> <a href="fResetPasswordUser.aspx" class="text-dark pull-right"> <i class="fa fa-lock m-r-5"></i>Forgot pwd?</a> </div>
                        </div>
                        <div class="form-group text-center m-t-20">
                           <div class="col-xs-12">
                                <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="btn btn-block btn-outline-info" style="width:100%;font-weight:600" OnCommand="btnLogin_Command"  />
                            </div>
                        </div>
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                <div>Don't have an account? <a href="fRegisterUser.aspx" class="text-info m-l-5"><b>Sign Up</b></a></div>
                            </div>
                        </div>
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                <div>You are<a href="fLoginAdmin.aspx" class="text-info m-l-5"><b>administrators?</b></a></div>
                            </div>
                        </div>
                    </div>
                </div>
