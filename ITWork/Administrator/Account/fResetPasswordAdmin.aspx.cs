...
{
    public partial class fResetPasswordAdmin : System.Web.UI.Page
    {
        ...
        protected void btnResetPassword_Command(object sender, CommandEventArgs e)
        {
            ...
            AccountAdministrator obj = db.AccountAdministrators.FirstOrDefault(x => x.Username == username && x.Email == email);
            if(obj != null)
            {
