<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fLoginAdmin.aspx.cs" Inherits="ITWork.Administrator.Account.fLoginAdmin" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <!-- Original URL: http://themedesigner.in/demo/admin-press/main/pages-login-2.html
                ...
                <div class="form-horizontal form-material" id="loginform">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <a href="fResetPasswordAdmin.aspx" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Forgot pwd?</a> </div>
                    </div>
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <asp:Button ID="btnLogin" runat="server" Text="Login" class="btn btn-block btn-outline-info" style="width:100%;font-weight:600" OnCommand="btnLogin_Command" />
                        </div>
                    </div>
                    <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                <div>Don't have an account? <a href="fRegisterAdmin.aspx" class="text-info m-l-5"><b>Sign Up</b></a></div>
                            </div>
                        </div>
                    
                    <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                <div>You are <a href="fLoginUser.aspx" class="text-info m-l-5"><b>user?</b></a></div>
                            </div>
                    </div>
                </div>
                </div>
