! function(e, t) {
    ...
    r("tinymce/pasteplugin/Utils", ["tinymce/util/Tools", "tinymce/html/DomParser", "tinymce/html/Schema"], function(e, t, n) {
        ...
        function u(u) {
            ...
            u.on("BeforePastePreProcess", function(d) {
                function f(e) {
                    ...
                    for (var a, u, c = 1, d = [], f = e.firstChild;
                ...
                if (g = g.replace(/<b[^>]+id="?docs-internal-[^>]*>/gi, ""), g = g.replace(/<br class="?Apple-interchange-newline"?>/gi, ""), h = c.paste_retain_style_properties, h && (m = e.makeMap(h.split(/[, ]/))), c.paste_enable_default_filters !== !1 && a(d.content)) {
                    ...
                    var C = b.parse(g);
                    c.paste_convert_word_fake_lists !== !1 && f(C), d.content = new r({
                        validate: c.validate
                    }, y).serialize(C)
                }
            })
        ...
        e.add("paste", function(o) {
            ...
            function s() {
                if ("text" == u.pasteFormat) u.pasteFormat = "html", o.fire("PastePlainTextToggle", {
                    state: !1
                });
                else if (u.pasteFormat = "text", o.fire("PastePlainTextToggle", {
                        state: !0
                    }), !a()) {
