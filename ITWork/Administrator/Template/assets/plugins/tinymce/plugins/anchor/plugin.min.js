    ...
    var t = function(e) {
        ...
        i = function() {
            ...
            n && (i = t.id || t.name || ""), e.windowManager.open({
                ...
                onsubmit: function(i) {
                    var o = i.data.id;
                    return r(o) ? void(n ? (t.removeAttribute("name"), t.id = o) : (e.selection.collapse(!0), e.execCommand("mceInsertContent", !1, e.dom.createHTML("a", {
                        id: o
                    })))) : (i.preventDefault(), void e.windowManager.alert("Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores."))
                }
            })
        };
