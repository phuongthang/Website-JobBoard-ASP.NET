        ...
        var r = e.EMPTY_STRING,
            ...
            u = function(e, s) {
                var u, c, d, f = 0,
                    ...
                    m = [],
                    g = [];
                for (s || (s = {}), s.ignoreCase && (e = e.toLowerCase()), c = s.includePunctuation, d = s.includeWhitespace; f < h; ++f)
                    if (u = e.charAt(f), m.push(u), n.isWordBoundary(p, f)) {
                        if (m = m.join(r), m && (d || !i.test(m)) && (c || !o.test(m)))
                            if (a(m)) {
                                var v = l(m, e, f);
