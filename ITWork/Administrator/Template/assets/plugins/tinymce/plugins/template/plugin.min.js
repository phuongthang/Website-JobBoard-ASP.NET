tinymce.PluginManager.add("template", function(e) {
    ...
    function a(t, n) {
        ...
        n = o(n, "template_replace_values"), l = c.create("div", null, n), u = c.select(".mceTmpl", l), u && u.length > 0 && (l = c.create("div", null), l.appendChild(u[0].cloneNode(!0))), s(c.select("*", l), function(t) {
