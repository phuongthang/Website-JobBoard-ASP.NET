! function() {
    ...
    function t(t, n, r, i, o) {
        ...
        function s(t) {
            ...
            if (h[t.nodeName] && !p[t.nodeName]) return "";
            if (n = "", e(t)) return "\n";
        ...
        function l(t, n, r) {
            var i, o, a, s, l = [],
                ...
                f = 0;
            e: for (;;) {
                if ((p[c.nodeName] || m[c.nodeName] || e(c)) && u++, 3 === c.nodeType && (!o && c.length + u >= d[1] ? (o = c, s = d[1] - u) : i && l.push(c), !i && c.length + u > d[0] && (i = c, a = d[0] - u), u += c.length), i && o) {
                    if (c = r({
                            startNode: i,
                            startNodeIndex: a,
                            endNode: o,
                            ...
                            match: d[2],
                            matchIndex: f
                        }), u -= o.length - s, i = null, o = null, l = [], d = n.shift(), f++, !d) break
                } else if (h[c.nodeName] && !p[c.nodeName] || !c.firstChild) {
                    if (c.nextSibling) {
                        c = c.nextSibling;
                        continue
                    }
        ...
        function u(e) {
            ...
            return function(e) {
                ...
                if (o === a) {
                    ...
                    var u = t(e.match[0], s);
                    return i.insertBefore(u, l), e.endNodeIndex < l.length && (r = f.createTextNode(l.data.substring(e.endNodeIndex)), i.insertBefore(r, l)), l.parentNode.removeChild(l), u
                }
                n = f.createTextNode(o.data.substring(0, e.startNodeIndex)), r = f.createTextNode(a.data.substring(e.endNodeIndex));
                for (var c = t(o.data.substring(e.startNodeIndex), s), d = [], p = 0, h = e.innerNodes.length; p < h; ++p) {
                    var m = e.innerNodes[p],
                        g = t(m.data, s);
                    m.parentNode.replaceChild(g, m), d.push(g)
                }
                var v = t(a.data.substring(0, e.endNodeIndex), s);
                return i = o.parentNode, i.insertBefore(n, o), i.insertBefore(c, o), i.removeChild(o), i = a.parentNode, i.insertBefore(v, a), i.insertBefore(r, a), i.removeChild(a), v
            }
        }
        var c, d, f, p, h, m, g = [],
            v = 0;
        if (f = n.ownerDocument, p = o.getBlockElements(), h = o.getWhiteSpaceElements(), m = o.getShortEndedElements(), d = s(n)) {
            if (t.global)
                for (; c = t.exec(d);) g.push(a(c, i));
            else c = d.match(t), g.push(a(c, i));
            return g.length && (v = g.length, l(n, g, u(r))), v
        }
    }
    ...
    function n(e) {
        function n() {
            ...
            var o = e.windowManager.open({
                ...
                onSubmit: function(e) {
                    var r, s, l, u;
                    return e.preventDefault(), s = o.find("#case").checked(), u = o.find("#words").checked(), l = o.find("#find").value(), l.length ? i.text == l && i.caseState == s && i.wholeWord == u ? 0 === a(d + 1).length ? void n() : (c.next(), void t()) : (r = c.find(l, s, u), r || n(), o.statusbar.items().slice(1).disabled(0 === r), t(), void(i = {
                        text: l,
                        caseState: s,
                        wholeWord: u
                    })) : (c.done(!1), void o.statusbar.items().slice(1).disabled(!0))
                },
                buttons: [{
                    text: "Find",
                    subtype: "primary",
                    ...
                    disabled: !0,
                    onclick: function() {
                        c.replace(o.find("#replace").value()) || (o.statusbar.items().slice(1).disabled(!0), d = -1, i = {})
                    }
                }, {
                    text: "Replace all",
                    disabled: !0,
                    onclick: function() {
                        c.replace(o.find("#replace").value(), !0, !0), o.statusbar.items().slice(1).disabled(!0), i = {}
                    }
                }, {
                    type: "spacer",
                    flex: 1
        ...
        function i(n) {
            ...
            return i = e.dom.create("span", {
                "data-mce-bogus": 1
            }), i.className = "mce-match-marker", r = e.getBody(), c.done(!1), t(n, r, i, !1, e.schema)
        }
        ...
        c.init = function(e) {
            ...
            var e = s(!1);
            e !== -1 && (d = e)
        }, c.replace = function(t, n, i) {
            var s, f, p, h, m, g, v = d;
            for (n = n !== !1, p = e.getBody(), f = tinymce.grep(tinymce.toArray(p.getElementsByTagName("span")), u), s = 0; s < f.length; s++) {
                var y = r(f[s]);
                if (h = m = parseInt(y, 10), i || h === d) {
                    for (t.length ? (f[s].firstChild.nodeValue = t, o(f[s])) : l(f[s]); f[++s];) {
                        if (h = parseInt(r(f[s]), 10), h !== m) {
                            s--;
                            break
                        }
                        l(f[s])
            ...
            return e.undoManager.add(), d = v, n ? (g = a(v + 1).length > 0, c.next()) : (g = a(v - 1).length > 0, c.prev()), !i && g
        }, c.done = function(t) {
            var n, i, a, s;
            ...
            if (a && s) {
                ...
                return u.setStart(a, 0), u.setEnd(s, s.data.length), t !== !1 && e.selection.setRng(u), u
            }
        }
    }
