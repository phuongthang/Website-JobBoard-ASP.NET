<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Dashboard/SiteDashboard.Master" AutoEventWireup="true" CodeBehind="fDetailCV.aspx.cs" Inherits="ITWork.Administrator.Dashboard.fDetailCV" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <asp:Image ID="imageAvt" runat="server" class="img-circle" width="150"></asp:Image>
                                    ...
                                    <h6 class="card-subtitle"><asp:Label ID="lbNickname" runat="server"></asp:Label></h6>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <p style="font-weight:bold"><i class="fa fa-calendar text-warning" style="margin-right:10px"></i>Birthday :</p>
                                                <p><asp:Label ID="lbbirthday" runat="server" ></asp:Label></p>
                                            </div>
                                            <div class="col-md-3">
                                        ...
                                        <p class="btn btn-danger">My Experience :</p>
                                        <p class="m-t-30"><asp:Label ID="lbExperience" runat="server"></asp:Label></p>
                                        <hr />
                                        <p class="btn btn-danger">My Skills :</p>
                                        <p class="m-t-30"><asp:Label ID="lbSkill" runat="server"></asp:Label></p>
                                        <hr />
                                        <p class="btn btn-danger">Detail:</p>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-center">
                                                <asp:Image ID="imgCV" runat="server" style="width:650px" />
                                            </div>
