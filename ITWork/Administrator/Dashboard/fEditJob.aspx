<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Dashboard/SiteDashboard.Master" AutoEventWireup="true" CodeBehind="fEditJob.aspx.cs" Inherits="ITWork.Administrator.Dashboard.fEditJob" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Job Edit</h3>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Job Edit</h4>
                            </div>
                            <div class="card-body">
                                <div>
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group has-success">
                                                    ...
                                                    <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" class="form-control ckeditor" Rows="10" required=""></asp:TextBox>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group has-success">
                                                    ...
                                                    <asp:TextBox ID="txtRequiredSkill" runat="server" TextMode="MultiLine" class="form-control ckeditor" Rows="10" required=""></asp:TextBox>
                                                </div>
                                            </div>
                                            </div>
