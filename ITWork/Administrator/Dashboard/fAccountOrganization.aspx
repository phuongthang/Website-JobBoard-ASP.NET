<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Dashboard/SiteDashboard.Master" AutoEventWireup="true" CodeBehind="fAccountOrganization.aspx.cs" Inherits="ITWork.Administrator.Dashboard.fAccountOrganization" %>
    ...
    <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Account Organization</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Account Organizations</h4>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="dgvAccountOrganization" runat="server" class="table table-bordered" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="Center" AlternatingRowStyle-BackColor="#eff2f7" AlternatingRowStyle-ForeColor="#495057" AllowPaging="true" OnPageIndexChanging="dgvAccountOrganization_PageIndexChanging" PageSize="5" >
...
<asp:Content ID="Content3" ContentPlaceHolderID="foot" runat="server">
    <script>
        ...
        function checkReset() {
            if (confirm("Bạn có chắc muốn reset mật khẩu này không ??") == true) {
                return true;
            }
            return false;
        }
