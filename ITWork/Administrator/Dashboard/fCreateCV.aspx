<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Dashboard/SiteDashboard.Master" AutoEventWireup="true" CodeBehind="fCreateCV.aspx.cs" Inherits="ITWork.Administrator.Dashboard.fCreateCV" %>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group has-success">
                                                    ...
                                                    <asp:TextBox ID="txtExperience" runat="server" TextMode="MultiLine" class="form-control" Rows="10" required=""></asp:TextBox>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group has-success">
                                                    ...
                                                    <asp:TextBox ID="txtSkill" runat="server" TextMode="MultiLine" class="form-control" Rows="10" required=""></asp:TextBox>
                                                </div>
                                            </div>
