<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Dashboard/SiteDashboard.Master" AutoEventWireup="true" CodeBehind="fProfilePerson.aspx.cs" Inherits="ITWork.Administrator.Dashboard.fProfilePerson" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <asp:Image ID="imageAvt" runat="server" class="img-circle" width="150"></asp:Image>
                                    ...
                                    <h6 class="card-subtitle"><asp:Label ID="lbPosition" runat="server"></asp:Label></h6>
                                    ...
                                    <div class="card-body">
                                        <div class="form-horizontal form-material">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <asp:TextBox ID="txtpositionedit" runat="server" class="form-control form-control-line"></asp:TextBox>
